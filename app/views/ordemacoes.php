                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="qtform" name="qtform" value="<?php echo $ordem[0]["qtform"];?>" type="text" placeholder="" class="form-control" maxlength = "15" <?php if($acao == 'ver' or $acao == 'apaga'): ?>readonly<?php endif; ?> required>
                                                </div>
                                            </div>
